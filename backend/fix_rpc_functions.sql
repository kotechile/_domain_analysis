...
BEGIN
    ...
    -- Step 1: Merge from staging using UPSERT
    -- This version DOES NOT mark everything for deletion. 
    -- It updates existing records and returns NEW ones (where score is NULL).
