...
class AuctionsService:
    ...
    async def get_auctions_missing_any_metric_with_filters( self, filters: Optional[Dict[str, Any]] = None, sort_by: str = 'expiration_date', sort_order: str = 'asc', limit: int = 1000 ) -> List[Dict[str, Any]]:
        """
        ...
        Returns:
            List of auction dictionaries with domain, expiration_date, and id
        """
        return await self.await db.get_auctions_missing_any_metric_with_filters( filters=filters, sort_by=sort_by, sort_order=sort_order, limit=limit )
